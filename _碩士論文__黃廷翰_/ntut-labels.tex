...
\newcommand\cTitle{融合目擊 IoC 與 CTI 情資資料進行APT組織辨識之方法研究}

% 我的姓名（中文）
% My Name（Chinese）
\newcommand\myCname{黃廷翰}

% 指導教授的姓名 (中文)，使用頓號隔開 
% Advisor (Chinese), use “、” to separate names
\newcommand\advisorCname{孫勤昱 博士}
...
\newcommand\eTitle{DeepPath: Explainable APT Attribution based on Heterogeneous CTI Graph and TTP Subgraph Matching}

% 我的姓名（英文）
% My Name（English）
\newcommand\myEname{Huang, Ting-Han}
...
\newcommand\advisorEname{Dr. Sun Chin-Yu}
